...
import ProjectList from "@/components/isotope/projectsList";
...
const page = () => {
  ...
  return (
    <>
      <Script
        async
        src="https://www.googletagmanager.com/gtag/js?id=G-GHQSJGQXF3"
    ...
    `}
      ...
      >
            ...
            <div className="row gap-70 align-items-center">
              <div className="col-lg-6">
                ...
                >
                  ...
                  <p>
                    I build dynamic, user-centric web apps, blending front-end
                    and back-end expertise to craft seamless, responsive
                    experiences.
                  </p>
        ...
        >
          <div className="container">
            ...
            <p>
              ...
              applications, ensuring seamless functionality. Alongside my
              passion for technology, I enjoy hiking and playing football, which
              help me stay active and balanced. I’m always eager to learn, grow,
              and use my skills to create innovative solutions that make a
              difference.
            </p>
          </div>
        </section>
                    ...
                    <div className="col-lg-6">
                      <div className="content rmb-55">
                        <div className="section-title mb-30">
                          <h2>
                            Hasegawa Memorial Public School and College
                            Karimabad Hunza
                          </h2>
                        </div>
                        <p>
                          At Hasegawa Memorial Public School and College, I
                          gained foundational skills in academics and
                          extracurricular activities. Throughout my time here, I
                          developed key competencies in Microsoft Excel and
                          Word, along with soft skills such as effective
                          communication and presentation abilities, which have
                          been essential in both academic and personal growth.
                        </p>
                    ...
                    <div className="col-lg-6">
                      ...
                      >
                        ...
                        <p>
                          ...
                          skills in C and developed proficiency in Microsoft
                          Excel and Word. I also enhanced my presentation skills
                          and became adept at presentation development,
                          preparing me to communicate technical ideas
                    ...
                    <div className="col-lg-6">
                      <div className="content rmb-55">
                        ...
                        <p>
                          ...
                          exploring key topics like Data Structures and
                          Object-Oriented Programming (OOP). I have also
                          developed skills in project planning, presentation
                          development, and communication, essential for both
                          academic and professional growth. Outside of
                          academics, I actively participate in football and
                          volleyball, enhancing my teamwork and leadership
                          abilities.
                        </p>
                        <ul className="icon-list mt-20 mb-40">
                          <li>
                  ...
                  <div className="row align-items-center justify-content-between">
                    ...
                    <div className="col-lg-6">
                      <div className="content rmt-55">
                        ...
                        <p>
                          As an intern at Crogics Pvt Ltd, I am working as a
                          MERN Stack Developer, gaining hands-on experience in
                          Node.js and tackling real-world problem-solving
                          challenges. I am actively involved in backend
                          development, refining my skills in database
                          management, APIs, and JavaScript. Additionally, I am
                          enhancing my expertise in project collaboration,
                          version control, and continuous learning, while
                          contributing to a range of projects that strengthen my
                          development and technical problem-solving abilities
                  ...
                  <div className="row align-items-center justify-content-between">
                    <div className="col-lg-6">
                      <div className="content rmb-55">
                        ...
                        <p>
                          As a volunteer Patrol Leader in Hunza, Pakistan, I
                          have had the privilege of contributing to community
                          development and youth empowerment in a region
                          celebrated for its natural beauty and rich cultural
                          heritage. I led various scouting activities, such as
                          outdoor adventures, educational workshops, and
                          community service projects, with a focus on developing
                          leadership skills, teamwork, and environmental
                      ...
                      <div className="content rmb-55">
                        ...
                        <ul className="icon-list mt-20 mb-40">
                          ...
                          <li>
                            <i className="fal" /> Jan 2018 – Jan 2019 (1 yr 1
                            mo)
                          </li>
                          {/* <li>
                          <i className="fal " />
                  ...
                  <div className="feature-icon-box mt-35">
                    ...
                    <div className="content">
                      <p>
                        ...
                        passion of mine, as it helps me maintain physical
                        fitness while being incredibly refreshing.
                      </p>
                    </div>
                  </div>
                  <div className="feature-icon-box">
                    ...
                    <div className="content">
                      <p>
                        ...
                        heights. These activities not only keep me physically
                        fit but also help me develop resilience and a sense of
                        adventure.
                      </p>
                    </div>
                  </div>
        ...
        <div style={{ backgroundColor: "#001726", color: "white" }}>
          <ProjectsIsotope />
        </div>
        <section
        ...
        >
            ...
            >
              <div>
                <div className="testimonial-item-two">
                  ...
                  <div className="author-text">
                    MR Rahman Karim is an exceptional MERN stack developer with
                    a strong foundation in web development and database
                    management. His ability to integrate front-end and back-end
                    seamlessly ensures user-friendly and efficient applications.
                    He consistently demonstrates a passion for learning and
                    exploring his field.
                  </div>
                </div>
              </div>
              <div>
                <div className="testimonial-item-two">
                  ...
                  <div className="line" />
                  <div className="author-text">
                    Rahman is a talented and dedicated student of computer
                    science with a keen interest in data science and software
                    development. His hands-on experience with projects,
                    showcases his technical expertise and creative
              ...
              <div>
                <div className="testimonial-item-two">
                  ...
                  <div className="author-text">
                    ...
                    experience and coursework reflect his commitment to
                    mastering his field, while his collaborative attitude makes
          ...
          <div className="testimonial-nine-shapes">
            <div className="shape one">
              <img
                src="assets/images/shapes/testimonial-left.png"
                alt="Shape"
              />
            </div>
            <div className="shape two">
              <img
                src="assets/images/shapes/testimonial-right.png"
                alt="Shape"
              />
            </div>
          </div>
